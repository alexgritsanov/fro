...
export const TransfersStepRenderer: React.FC<CertificateStepProps> = ({
  formData,
  updateFormData,
  moveToNextStep,
  moveToPrevStep,
  ...
  return (
    ...
    >
      <div className="flex items-center mb-6">
        <ArrowLeftRight className="h-6 w-6 text-blue-600 mr-3" />
        <h2 className="text-2xl font-bold">Transfers on Site</h2>
      </div>
      
      <div className="mb-6">
        <QuickHourSelection
          value={formData.transfers || "None"}
          setValue={(value) => updateFormData('transfers', value)}
          label="Transfers on Site"
